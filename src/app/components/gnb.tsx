...
export function GNB() {
  return (
    <header className="h-[52px] min-h-[52px] bg-white border-b border-[#E0E3E8] flex items-center px-5 gap-4">
      {/* Logo */}
      <div className="flex items-center gap-2 shrink-0">
        <div className="w-6 h-6 rounded bg-[#1A73E8] flex items-center justify-center text-white text-[12px]">
          D
        </div>
        <span className="text-[#1A73E8] text-[24px]">dnagol CRM</span>
      </div>

      {/* Breadcrumb area - placeholder */}
      <div className="flex items-center gap-1.5 text-[18px] text-[#999] ml-4">
      ...
      <div className="relative w-[320px]">
        ...
        <input
          ...
          className="w-full bg-[#F7F8FA] border border-[#E0E3E8] rounded-md pl-9 pr-4 py-[7px] text-[18px] text-[#1A1A1A] placeholder-[#999] focus:outline-none focus:border-[#1A73E8] transition-colors"
        />
      </div>
      ...
      <div className="flex items-center gap-2 pl-3 border-l border-[#E0E3E8]">
        <div className="w-7 h-7 rounded-full bg-[#2CBF60] flex items-center justify-center text-white text-[11px]">
          김
        </div>
        <span className="text-[18px] text-[#1A1A1A]">airtor2014</span>
